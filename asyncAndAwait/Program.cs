    ...
    class Program
    {
        static async Task Main(string[] args)
        {
            try
            {
                ...
                TurnOffAlarm();
                Console.WriteLine("Got out of bed");
        ...
        private static void GetDressed() => Console.WriteLine("Getting dressed");
        ...
        private static async Task<Drive> DriveToWorkAsync(int time)
        {
            ...
            await Task.Delay(1000);
            //Console.WriteLine("Oh no, forgot wallet!");
            //throw new InvalidOperationException("Have to turn around");
